#Небольшой скрипт по работе с графической библиотекой tkinter для python.
#В основе лежит описание трех классов Ball, Paddle, Score
#взаимоувязанных небольшой логикой в конце.
#Пуск скрипта осуществляем через команду Run в VsCode.
